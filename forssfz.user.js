...
// @name         关闭弹窗
// @version      0.0.0
// @namespace    songlll/forssfz
// @author       songlll
// @description  songlll为山师附中项目部2027级一班定制的脚本！我真是太NB了。
// @match        *://*.bilibili.com/*
...
(function () {
  "use strict";
  function forceBiliWebFullscreen() {
    // 找到 aria-label 为 “全屏” 的按钮
    const fullscreenBtn = Array.from(document.querySelectorAll(".bpx-player-ctrl-btn"))
      .find(btn => btn.getAttribute("aria-label") === "全屏");
    if (fullscreenBtn) {
      // 点击一次
      fullscreenBtn.click();
    }
